...
function ResultImage ({ publicId, width, height, onDeleteImage }) {
  return (
    <div className='relative'>
      <span title='Delete Image' onClick={() => onDeleteImage(publicId)} className="bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300 absolute right-0 m-0 cursor-pointer select-none">メ</span>
      <a
